...
def registerNoesisTypes():
	handle = noesis.register("Legacy of Kain: Defiance (PC)", ".drm")
...
def bcLoadModel(data, mdlList):
	...
	for a in range(entries):
        ...
        # Not sure what the types are in Defiance. Assuming they're all the same.
		entry_type = 0
	...
	# Defiance doesn't use a gnc_id, but it's always the first one.
